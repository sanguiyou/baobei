    ...
    methods: {
        list_callback: function (ajax_json) {  
            ...
            $('#pageLimit1').bootstrapPaginator({
                ...
                onPageClicked: (event, originalEvent, type, page)=> {
                    ...
                    jquery_ajax(ACTION_URL.departments_list,"post",this.search_param,true,this.list_callback);  
                }
            }); 
        ...
        del_record(id){            
            if(confirm("确定要删除此记录吗？")){
                jquery_ajax(ACTION_URL.departments_delete+"?id="+id,"get",undefined,true,()=>{
                    alert("操作成功");
