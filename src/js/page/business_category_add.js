var vue_instance = new Vue({
    ...
    methods: {
        submit_form:function () {                        
            ...
            jquery_ajax(ACTION_URL.business_category_modify,"post",this.form_data,true,(json_result)=>{                
        ...
        load_edit_data(){ //拉取修改页的数据            
            jquery_ajax(ACTION_URL.business_category_detail,"post",this.form_data.id,false,(json_result)=>{
