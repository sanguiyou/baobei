...
var vue_instance = new Vue({
    ...
    methods: {
        submit_form:function () {                        
            ...
            return;               
            jquery_ajax(ACTION_URL.shadow_users_modify,"post",this.form_data,this.submit_form_callback);                    
        },
        ...
        load_baobei_list(){
            //jquery_ajax(ACTION_URL.shadow_users_modify,"post",this.form_data,this.load_baobei_callback); 
            this.load_baobei_callback();
        },
        load_baobei_callback(json_result){
            json_result = ["报备人A","报备人B"];
            this.baobei_list = json_result;
        }
    },
    created: function () {
        //拉取报表列表
